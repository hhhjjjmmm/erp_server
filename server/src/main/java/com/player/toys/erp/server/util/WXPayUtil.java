...
import com.player.toys.erp.server.logic.VO.UnifiedOrderRequest;
import com.player.toys.erp.server.logic.VO.UnifiedOrderRespose;
import com.player.toys.erp.server.logic.VO.WXPayConstants;
...
public class WXPayUtil {
    ...
    private static String createSign(UnifiedOrderRequest unifiedOrderRequest) {
        ...
        sb.append("key="+"你的密匙");
        String sign = MD5.MD5(sb.toString()).toUpperCase();//MD5加密
